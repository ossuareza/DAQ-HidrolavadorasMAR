...
void generate_html(characterized_pump pump, int measure_n){
    ...
    "\t\ta.comment-indicator:hover + comment { background:#ffd; position:absolute; display:block; padding:0.5em;  } \n"
    "\t\ta.comment-indicator { background:red; display:inline-block; width:0.5em; height:0.5em;  } \n"
    ...
    // "\t\t</tr>\n"
    // "\t<tr>\n"
    "\t\t<td colspan=8 height=\"50\" align=\"center\" ><img src=\"FlowVsPower.png\" alt=\"Flujo vs Potencia\" width=\"900\" height=\"300\"></td>\n"
    "\t\t</tr>\n"
    "\t<tr>\n"
    "\t\t<td colspan=8 height=\"50\" align=\"center\" ><img src=\"FlowVsHead.png\" alt=\"Flujo vs Cabeza\" width=\"900\" height=\"300\"></td>\n"
    "\t\t</tr>\n"
    "\t<tr>\n"
    "\t\t<td colspan=8 height=\"50\" align=\"center\" ><img src=\"FlowVsEfficiency.png\" alt=\"Flujo vs Eficiencia\" width=\"900\" height=\"300\"></td>\n"
    "\t\t</tr>\n"
    "</table>\n"
    "<!-- ************************************************************************** -->\n"
    "</body>\n"
